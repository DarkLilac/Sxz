...
namespace Library
{
    public class GrayBitPlaneChunk : Chunk
    {
        public GrayBitPlaneChunk()
        {
        }
        ...
        public static string Label { get { return "GB"; } }
        ...
        public SxzColor GetColor(int x, int y)
        {
            ...
            byte b = GetByteIndex(x - Origin.X, y - Origin.Y);

            return new SxzColor(b, b, b);
        }
